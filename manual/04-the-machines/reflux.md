...
- Resonance and drive together make the classic sound. Most acid patches have
  both up and the cutoff moving.
- Record the cutoff knob as automation while the song plays rather than drawing
  it in.
- Two Refluxes playing the same clip, one plucked and one sliding, panned apart
  with slightly different cutoffs, is an old trick that still works.

*Reflux was called Subvert in earlier versions. Songs and patches from then open as Reflux.*
